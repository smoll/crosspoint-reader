...
#include "token/TokenModeActivity.h"
...
void ActivityManager::goToTokenMode() { replaceActivity(std::make_unique<TokenModeActivity>(renderer, mappedInput)); }
...
void ActivityManager::goHome(HomeMenuItem initialMenuItem) {
  if (initialMenuItem == HomeMenuItem::NONE && currentActivity) {
    ...
    } else if (activityName == "TokenMode") {
      initialMenuItem = HomeMenuItem::TOKEN_MODE;
