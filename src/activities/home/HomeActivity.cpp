...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_TOKEN_MODE), tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS),
                                        tr(STR_FILE_TRANSFER), tr(STR_SETTINGS_TITLE)};
  std::vector<UIIcon> menuIcons = {Image, Folder, Recent, Transfer, Settings};
